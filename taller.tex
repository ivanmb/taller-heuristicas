...
\title[Algoritmos y Estructuras de Datos III]{Taller de Heurísticas}
...
\begin{frame}{Introducción}
 \begin{block}{¿Qué vamos a hacer?}
	Vamos a introducir un problema nuevo de optimización combinatoria, profundizarlo un poco, pensar heurísticas e implementarlas.
  \end{block}
  \pause
...
\begin{block}{Problema de optimización}
	Dado un grafo $G$, el problema de mínimo conjunto dominante consiste en encontrar un conjunto dominante de $G$ con la menor
	cantidad posible de nodos.
\end{block} 
\pause
\begin{block}{Pregunta 2}
	Dado un grafo $G$ cualquiera, ¿el mínimo conjunto dominante será único?
\end{block} 
\end{frame}
...
¿Cómo identificamos si un conjunto de dos nodos es óptimo o podemos mejorarlo?
...
¿Qué pasa en general cuando tenemos varias componentes conexas? ¿Cómo impacta en el conjunto dominante?
\end{block}
...
Pueden encontrar muchas familias de grafos útiles en los links de las referencias.

\end{frame}


%\begin{frame}{Heurísticas constructivas greedy}
%\begin{block}{Ideas constructivas}
%	\begin{itemize}
%		\item \pause Nodo de mayor grado
%		\item \pause Nodo con mayor cantidad de vecinos aún no dominados
%		
%	\end{itemize}
%\end{block}
%\end{frame}
%
%\begin{frame}{Heurísticas de búsqueda local}
%\end{frame}
